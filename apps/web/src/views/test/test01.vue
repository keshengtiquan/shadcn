<template>
  <div>
    <GridTable ref="gridRef" :gridOptions="gridOptions" :grid-events="gridEvents"/>
  </div>
</template>

<script setup lang="ts">
import {GridTable} from "@workspace/vxe-table";
import {VxeGridProps, VxeGridListeners} from '@workspace/vxe-table'
